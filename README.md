...
The examples are configured for the local REWP development data:

```text
../sLoretta/rewpGrandERP.mat
```
...
and channel locations from:

```text
../sLoretta/matlocs.mat
```
...
```matlab
outputs = doWaveForms('../sLoretta/rewpGrandERP.mat', ...
    'DataVariable', 'grandERP', ...
    'ChanlocsFile', '../sLoretta/matlocs.mat', ...
    'SubjectIdx', 1, ...
    'ConditionPair', [1 2], ...
...
```matlab
outputs = doGroupWaveForms('../sLoretta/rewpGrandERP.mat', ...
    'DataVariable', 'grandERP', ...
    'ChanlocsFile', '../sLoretta/matlocs.mat', ...
    'ConditionPair', [1 2], ...
    'ConditionLabels', {'Win', 'Loss'}, ...
